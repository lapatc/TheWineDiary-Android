...
public class WineDatabaseHelper extends SQLiteOpenHelper {
	...
	private static final String CREATE_TABLE_WINERY = "CREATE TABLE "
			+ TABLE_WINERY + "(" + KEY_ID + " INTEGER PRIMARY KEY," + KEY_NAME
	...
	private static final String CREATE_TABLE_WINE = "CREATE TABLE "
			+ TABLE_WINE + "(" + KEY_ID + " INTEGER PRIMARY KEY," + KEY_YEAR
			+ " TEXT," + KEY_SPARKLING + " INTEGER," + KEY_ALCOHOL
			+ " INTEGER," + KEY_NAME + " TEXT NOT NULL," + KEY_DATE_TASTED
			+ " NUMERIC," + KEY_WINERY_ID + " INTEGER," + KEY_COLOR
			+ " TEXT NOT NULL," + KEY_LABEL_FRONT + " BLOB," + KEY_LABEL_BACK
			+ " BLOB," + KEY_TASTING_NOTE + " TEXT," + KEY_PERSONAL_NOTE
	...
	public Cursor getBasicWineData() {
		...
		String selectQuery = "SELECT wine." + KEY_ID + ", wine." + KEY_NAME
